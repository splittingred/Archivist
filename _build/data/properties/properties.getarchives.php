...
$properties = array(
    ...
    array(
        'name' => 'tagKey',
        'desc' => 'prop_getarchives.tagkey_desc',
        'type' => 'textfield',
        'options' => '',
        'value' => 'tags',
        'lexicon' => 'archivist:properties',
    ...
    array(
        'name' => 'tagKeyVar',
        'desc' => 'prop_getarchives.tagkeyvar_desc',
        'type' => 'textfield',
        'options' => '',
        'value' => 'key',
    ...
    array(
        ...
        'desc' => 'prop_getarchives.tagrequestparam_desc',
        'type' => 'textfield',
        'options' => '',
        'value' => 'tag',
        'lexicon' => 'taglister:properties',
    ...
    array(
        'name' => 'tagSearchType',
        'desc' => 'prop_getarchives.tagsearchtype_desc',
        'type' => 'list',
        'options' => array(
            array('text' => 'tst_contains','value' => 'contains'),
            array('text' => 'tst_exact','value' => 'exact'),
            array('text' => 'tst_beginswith','value' => 'beginswith'),
            array('text' => 'tst_endswith','value' => 'endswith'),
        ),
        'value' => 'contains',
        'lexicon' => 'taglister:properties',
    ),
